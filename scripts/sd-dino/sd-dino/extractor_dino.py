...
class ViTExtractor:
    ...
    def create_model(model_type: str) -> nn.Module:
        ...
        if 'v2' in model_type:
            model = torch.hub.load('facebookresearch/dinov2', model_type).cuda()
        elif 'dino' in model_type:
            model = torch.hub.load('facebookresearch/dino:main', model_type).cuda()
            ...
            model = torch.hub.load('facebookresearch/dino:main', model_type_dict[model_type]).cuda()
